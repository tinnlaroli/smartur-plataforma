    ...
    return (
        <div className="space-y-4">
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <button className="flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-violet-500">
                    ...
                    templates.map((template) => (
                        <div key={template.id} className="flex items-center justify-between rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-[#121214]">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button className="text-sm font-semibold text-violet-600 dark:text-violet-400">Editar</button>
                            </div>
                        </div>
                    ))
                )}
