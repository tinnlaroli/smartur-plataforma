            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-12 max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center">
                    ...
                    <div className="cta-content-right reveal-fade-up">
                        ...
                        {submitted ? (
                            <div className="flex items-center gap-3 py-4 font-bold" style={{ color: 'var(--color-green)' }}>
                            ...
                            >
                                ...
                                >
                                    <span>
                                        <span className="btn-base gap-2 py-3 sm:py-4 px-14 sm:px-16 text-base font-bold whitespace-nowrap" style={{ '--bg-color': 'var(--color-pink)' } as any}>
                                            {submitting ? '...' : t('contact.cta.button')}
                                            <ArrowRight className="h-5 w-5" />
                                        </span>
                                        <span className="btn-hover gap-2 py-3 sm:py-4 px-14 sm:px-16 text-base font-bold whitespace-nowrap" aria-hidden style={{ '--hover-text': 'var(--color-pink)' } as any}>
