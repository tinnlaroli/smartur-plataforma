...
export const HeroSection: React.FC<HeroSectionProps> = ({
    ...
    useEffect(() => {
        ...
        const animateHero = () => {
            ...
            const subtitleEl = hero.querySelector(
                '.hero-subtitle',
            ) as HTMLElement;
            ...
            const shimmerEl = hero.querySelector(
                '.hero-shimmer',
            ) as HTMLElement;

            const ctaShimmerEl = hero.querySelector(
                '.cta-shimmer',
            ) as HTMLElement | null;

            const scrollIndicatorEl = hero.querySelector(
                '.scroll-indicator',
            ) as HTMLElement;
            ...
            gsap.set([titleEl, subtitleEl, ctaEl], {
                opacity: 0,
            });
                ...
                if (isMobile) {
                    ...
                    wordsArr.forEach((w) => {
                        if (w.trim()) {
                            ...
                            span.className =
                                'hero-word inline-block perspective-[1000px]';
                            ...
                            if (
                                ...
                                span.style.color = 'rgb(var(--rgb-purple-accent))';
                            }

                            if (
                                wl.includes('turismo') ||
                                wl.includes('tourism') ||
                                wl.includes('tourisme')
                            ) {
                                span.style.color = 'rgb(var(--rgb-cyan-accent))';
                            }

                            if (w.includes(',')) {
                                span.innerHTML = w.replace(
                                    ',',
                                    ',<br/>',
                                );
                            } else {
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        'linear-gradient(120deg, transparent 0%, rgba(var(--rgb-purple-accent), 0.06) 30%, rgba(var(--rgb-orange-cta), 0.08) 50%, rgba(var(--rgb-cyan-accent), 0.06) 70%, transparent 100%)',
                }}
            />
            ...
            >
                <div
                    className="absolute -left-20 top-1/4 h-[400px] w-[400px] rounded-full opacity-[0.07] blur-[100px]"
                    style={{
                ...
                <div
                    className="absolute -right-20 bottom-1/4 h-[500px] w-[500px] rounded-full opacity-[0.08] blur-[120px]"
                    style={{
            ...
            <div className="u-container container relative z-10 mx-auto w-full px-4 pt-0">
                <div className="inner flex flex-row items-start justify-between gap-[5rem] pt-[2rem] pb-[4rem] lg:flex-row lg:items-start lg:gap-[4rem] lg:pt-[1.5rem] lg:pb-[3rem] md:flex-col md:items-start md:gap-[4rem] md:pt-[2rem] md:pb-[2rem] max-[767px]:flex-col max-[767px]:items-start max-[767px]:gap-[3rem] max-[767px]:pt-[4rem] max-[767px]:pb-[1rem]">
                    ...
                    <div className="content z-20 flex-1 max-w-none md:max-w-full">
                        <h1
                            className="u-heading title hero-title mb-0 text-[8.5rem] leading-[0.95] font-black lg:text-[7.2rem] md:text-[5.5rem] max-[767px]:text-[4.5rem]"
                            style={{
                                fontFamily:
                        ...
                        <div className="cta-wrapper hero-cta relative inline-block overflow-hidden mt-[2.75rem]">
                            ...
                            >
                                <span>
                                    ...
                                    <span
                                        className="btn-hover gap-3 px-10 py-5 text-xl font-bold"
                                        aria-hidden="true"
                                    >
                                        {t(
                                            'heroSection.cta',
