                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                            ...
                            <div className="col-span-2 grid grid-cols-2 gap-4 pt-2">
                                <div>
                                    ...
                                    <p className="text-[11px] text-zinc-600 dark:text-zinc-400" suppressHydrationWarning>{new Date(user.created_at).toLocaleString('es')}</p>
                                </div>
                                <div>
                                    <span className="mb-1 flex items-center gap-1.5 text-[10px] font-bold tracking-widest text-zinc-500 uppercase dark:text-zinc-500">
                                        <Calendar className="size-3" />
                                    ...
                                    <p className="text-[11px] text-zinc-600 dark:text-zinc-400" suppressHydrationWarning>{new Date(user.updated_at).toLocaleString('es')}</p>
                                </div>
                            </div>
