...
export const ui: Record<LanguageCode, Record<string, string>> = {
    es: {
        ...
        'actionBridge.tourist.description': 'Rutas personalizadas por IA, rincones con encanto y experiencias hechas para ti en las Altas Montañas de Veracruz.',
        'actionBridge.tourist.cta': 'Planear mi ruta',
        'actionBridge.business.label': 'Tengo un negocio',
        'actionBridge.business.description': 'Digitaliza tu oferta y conecta con turistas reales. Datos e IA pensados para hacer crecer tu negocio en la región.',
    ...
    en: {
        ...
        'nav.business': 'I have a business',
        ...
        'actionBridge.tourist.description': 'AI-crafted routes, hidden gems, and experiences made for you in the Altas Montañas of Veracruz.',
        'actionBridge.tourist.cta': 'Plan my route',
        'actionBridge.business.label': 'I have a Business',
        'actionBridge.business.description': 'Digitize your offer and connect with real tourists. Data and AI built to grow your business in the region.',
    ...
    fr: {
        ...
        'nav.business': 'J\'ai une entreprise',
        ...
        'actionBridge.tourist.description': 'Itinéraires créés par IA, lieux cachés et expériences taillées pour vous dans les Altas Montañas de Veracruz.',
        'actionBridge.tourist.cta': 'Planifier mon voyage',
        'actionBridge.business.label': 'J\'ai une entreprise',
        'actionBridge.business.description': 'Numérisez votre offre et connectez-vous avec de vrais touristes. Données et IA pensées pour développer votre activité.',
