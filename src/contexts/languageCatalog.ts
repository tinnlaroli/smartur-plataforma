...
export const ui: Record<LanguageCode, Record<string, string>> = {
    es: {
        ...
        'actionBridge.business.description': 'Impulsa tu visibilidad regional: digitaliza tu oferta y conecta con turistas gracias a datos e IA pensadas para crecimiento en las Altas Montañas.',
        'actionBridge.tourist.label': 'Soy turista',
        'actionBridge.tourist.description': 'Tu próxima aventura, curada por IA: rutas personalizadas, rincones con encanto y experiencias que se sienten hechas solo para ti.',
